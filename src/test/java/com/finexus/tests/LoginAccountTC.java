...
public class LoginAccountTC {
  ...
  @Test
  public void testLoginAccountTC() throws Exception {
    ...
    driver.findElement(By.id("password")).sendKeys("testdemot");
    driver.findElement(By.name("login")).submit();
	 selectFrame(1);

    driver.findElement(By.id("imgError")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Alerts Management'])[1]/following::span[1]")).click();
    driver.findElement(By.linkText("Product Catalog")).click();
	 selectWindow(1 );
	 selectFrame(2);

    driver.findElement(By.id("treestop1")).click();
    driver.findElement(By.id("treestart1")).click();
    driver.findElement(By.id("treestop1")).click();

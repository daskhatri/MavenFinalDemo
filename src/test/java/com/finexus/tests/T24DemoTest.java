...
public class T24DemoTest {
  ...
  @Test
  public void testT24Demo() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Currency'])[1]/following::td[2]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Currency'])[1]/following::td[2]")).click();
    ERROR: Unsupported command [doubleClick | xpath=(.//*[normalize-space(text()) and normalize-space(.)='Currency'])[1]/following::td[2] | ]
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Simulate New Arrangement'])[1]/preceding::img[11]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Balance Maintenance'])[1]/following::fieldset[1]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Simulate New Arrangement'])[1]/preceding::img[12]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='(SG TEST)'])[1]/following::td[3]")).click();
  }

...
public class GulBhaiDemonstration {
  ...
  @Test
  public void testGulBhaiDemonstration() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Assign Leave'])[2]/following::img[1]")).click();

...
public class OrangeHrmTC1 {
	...
	public void testOrangeHrmTC1() throws Exception {
		...
		driver.findElement(By.xpath(
				"(.//*[normalize-space(text()) and normalize-space(.)='Panel de inicio de sesión'])[1]/following::span[1]"))
				.click();
		...
		driver.findElement(
				By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Tiempo'])[1]/following::b[1]")).click();

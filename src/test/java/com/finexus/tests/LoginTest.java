...
public class LoginTest {
  ...
  public void testLogin() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='PB Term Loan'])[1]/following::img[1]")).click();
	 selectWindow(2 );
    driver.findElement(By.id("fieldName:CUSTOMER:1")).clear();
    driver.findElement(By.id("fieldName:CUSTOMER:1")).sendKeys("4008");
